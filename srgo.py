...
flag_tobs = "n"  # plot sky-localization area vs. observation time ([y]/n)
...
def f(t, f0, k, Z):
    ...
    if flag_mcmc == "y" and flag_sensi != "y" and flag_err != "y" and flag_range != "y" and flag_srcpos_skyloc != "y" and flag_psnr != "y" and flag_tobs != "y" and str(type(t)) == "<class 'numpy.ndarray'>":
        return (array([
...
def time(n, t_obs, t_ins, f0, k, Z):
    ...
    if flag_mcmc == "y" and flag_sensi != "y" and flag_err != "y" and flag_range != "y" and flag_srcpos_skyloc != "y" and flag_psnr != "y" and flag_tobs != "y":
    ...
    if flag_mcmc == "y" and flag_sensi != "y" and flag_err != "y" and flag_range != "y" and flag_srcpos_skyloc != "y" and flag_psnr != "y" and flag_tobs != "y" and len(t) > n:
        # to be able to use FFT trick for computing speed
        pts = len(t) - n
        t = t[:-pts]
    return t, T_timing
...
if flag_sensi == "y":
    ...
    plt.ylabel(
        "GW Strain Amplitude Spectral Density [1/$\sqrt{Hz}$]", fontweight='bold')
...
if flag_sensi != "y" and flag_err != "y" and flag_range != "y" and flag_srcpos_skyloc != "y" and flag_psnr != "y" and flag_tobs != "y":
