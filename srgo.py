...
LST = (00.0, 00.0, 00.0)
RA = (06.0, 00.0, 00.0)  # GW source right ascension in hh:mm:ss
dec = -67.5  # GW source declination in degrees
...
flag_srcpos_skyloc = "y"  # plot sky-loc precision vs. src position ([y]/n)
